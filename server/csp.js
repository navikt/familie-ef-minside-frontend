...
exports.cspString = exports.cspMap = void 0;
...
exports.cspMap = cspMap;
var cspString = function () {
    return Object.entries((0, exports.cspMap)())
        .map(function (entry) { return "".concat(entry[0], " ").concat(entry[1].join(' ')); })
        .join('; ');
};
exports.cspString = cspString;
