...
var TokenXClient = /** @class */ (function () {
    function TokenXClient() {
        ...
        this.audience = null;
        this.exchangeToken = function (idportenToken, applicationName) { return __awaiter(_this, void 0, void 0, function () {
            var clientAssertion;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.tokenxClient
                                ...
                                audience: "".concat(tokenxConfig.clusterName, ":teamfamilie:").concat(applicationName),
                            })
                                .then(function (tokenSet) {
                                return Promise.resolve(tokenSet.access_token);
                            })
                                .catch(function (err) {
                                logger_1.default.error('Feil under utveksling av token: ', err);
        ...
        this.asKey = function (jwk) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!jwk) {
                    logger_1.default.error('JWK Mangler');
                    throw Error('JWK Mangler');
                }
                return [2 /*return*/, node_jose_1.default.JWK.asKey(jwk).then(function (key) {
                ...
                switch (_a.label) {
                    case 0:
                        if (!tokenxConfig.discoveryUrl) {
                            logger_1.default.error('Mangler miljøvariabel TOKEN_X_WELL_KNOWN_URL');
                    ...
                    case 1:
                        ...
                        logger_1.default.info("Discovered TokenX @ ".concat(tokenx.issuer));
                        try {
                            ...
                            logger_1.default.info('Opprettet TokenX client');
                            return [2 /*return*/, Promise.resolve(client)];
                        }
                        catch (err) {
                            logger_1.default.error('Feil oppstod under parsing av jwt eller opprettelse av TokenX client', err);
        ...
        logger_1.default.info('Setter opp TokenX');
        this.init()
...
var tokenxConfig = {
    ...
    redirectUri: milj_1.miljø.oAuthCallbackUri,
